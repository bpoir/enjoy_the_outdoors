...
window.onload = function () {
  ...
  t.disabled = true;
  $.getJSON("assets/data/mountains.json", function (e) {
    l = e.mountains;
    l = l.sort((e, t) => {
...
function e() {
  ...
  let n = l.find((e) => e.name === t);
  a(n);
}
function i(e, t, n = "UTC") {
  const l = document.getElementById("sunriseDiv");
  const i = document.getElementById("sunsetDiv");
  l.innerHTML = `Sunrise: ${e} ${n}`;
